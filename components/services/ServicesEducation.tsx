...
export function ServicesEducation() {
  ...
  const educationalResources: EducationalResource[] = [
    ...
    },
    {
      ...
      description:
        "Core concepts of JavaScript explained clearly with practical examples for beginners and intermediate developers.",
      fileUrl: "/resources/JavaScriptFundamentals.pdf",
      icon: <IconBrandJavascript className="h-6 w-6" />,
      color: "yellow",
      fileSize: "1.5 MB",
      fileType: "PDF",
    },
