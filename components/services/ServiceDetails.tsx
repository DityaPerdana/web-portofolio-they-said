...
const services = [
  ...
  },
  {
    ...
    technologies: ["Python", "Node.js", "UiPath"],
    color: "yellow",
  },
  {
    id: "advertisement",
    ...
    icon: <IconDeviceDesktop className="h-6 w-6" />,
    description:
      "We specialize in creating powerful and efficient desktop applications tailored to meet your specific business needs. Our solutions are designed to deliver seamless performance, robust functionality, and an intuitive user experience across various platforms.",
    features: [
